---
layout:     post
title:      Spark快速入门-4-Spark性能优化指南-基础篇
subtitle:   
date:       2018-01-18
author:     Yezhiwei
...
![groupByKey实现wordcount原理](http://upload-images.jianshu.io/upload_images/268757-200de0d66a7525e1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![reduceByKey实现wordcount原理](http://upload-images.jianshu.io/upload_images/268757-9b30795bfa5d5066.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
*   将自定义的类型作为RDD的泛型类型时（比如JavaRDD<student style="padding: 0px; margin: 0px;">，Student是自定义类型），所有自定义类型对象，都会进行序列化。因此这种情况下，也要求自定义的类必须实现Serializable接口。</student>
...
![Spark基本运行原理](http://upload-images.jianshu.io/upload_images/268757-f395d707b171eaf2.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
[原文地址](https://tech.meituan.com/spark-tuning-basic.html)
